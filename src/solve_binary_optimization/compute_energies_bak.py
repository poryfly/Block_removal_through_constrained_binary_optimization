...
if __name__ == "__main__":
    ...
    parser.add_argument("-output_directory", type=str, default="/data2/work/Block_removal_through_constrained_binary_optimization/Amatrices/Qwen3-8B_n_samples_2048_think/")
