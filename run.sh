...
#step 2
python -u -m src.binary_optimization.prepare_binary_optimization --config_file configs/cbo_configs/deepseek-v4_pruning.yaml
...
#     -num_gpus 8 \
#     -top_k 100 \
#     > ./logs/compute_energies.log 2>&1 

#step 4
#python -u -m src.compression.compress_model --filename /data2/work/Block_removal_through_constrained_binary_optimization/Amatrices/Qwen3-8B_n_samples_2048_think/energies_del8 --model_name /data/.cache/models/Qwen/Qwen3-8B --k 3 > ./logs/compress_model.log 2>&1 
