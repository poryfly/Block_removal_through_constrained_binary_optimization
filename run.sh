...
#step 4
# python -u -m src.compression.compress_model --filename /data2/work/Block_removal_through_constrained_binary_optimization/Amatrices/deepseek-v4_n_samples_2048_think/energies_del27 --model_name /data/.cache/models/deepseek-ai/DeepSeek-V4-Flash --k 3 2>&1 | tee logs/compress_model.log
